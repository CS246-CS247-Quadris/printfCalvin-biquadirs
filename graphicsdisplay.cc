...
GraphicsDisplay:: GraphicsDisplay(int height, int width) {
    ...
    xw->drawBigString(25 + side * width + 10, 515, "Quadris. Created by M. Zhang, R. Liu and Y. Ren");
    xw->drawBigString(25 + side * width + 10, 530, "Copyright 2018 VCW. All rights reserved.");
}
